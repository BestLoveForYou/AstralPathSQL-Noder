...
public class DoIT {
    ...
    public static String doit(String readMessage, String Jurisdiction, String ip) throws IOException{
        ...
        try {
            ...
            if (sp[0].equals("client")) {
                Iterator<Map.Entry<String, NIOThread>> entries = conpool.entrySet().iterator();
            ...
            if (sp[0].equals("insert")) {
                writeMessage = INSERT.in(sp,readMessage);
            }
            /**
             *
             *查看表
            ...
            if (sp[0].equals("delete")) {
                writeMessage = DELETE.delete(sp,readMessage);
            }
            /**
             * 更新数据功能
            ...
            if (sp[0].equals("update")) {
                writeMessage = UPDATE.update(sp,readMessage);
            }
